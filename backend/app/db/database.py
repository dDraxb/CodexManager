...
def _ensure_session_columns(conn: sqlite3.Connection) -> None:
    ...
    alter_statements = [
        ...
        ("provider", "ALTER TABLE sessions ADD COLUMN provider TEXT NOT NULL DEFAULT 'codex'"),
        ("external_session_id", "ALTER TABLE sessions ADD COLUMN external_session_id TEXT"),
        ("external_transcript_path", "ALTER TABLE sessions ADD COLUMN external_transcript_path TEXT"),
        ("external_updated_at", "ALTER TABLE sessions ADD COLUMN external_updated_at INTEGER"),
